...
namespace DistanceReacher.Platforms.Android
{
    public class CustomMapHandler : MapHandler
    {
        private const int _iconSize = 100;

        private readonly Dictionary<string, BitmapDescriptor> _iconMap = new Dictionary<string, BitmapDescriptor>();
        ...
        public Dictionary<string, (Marker Marker, MapPin Pin)> MarkerMap { get; } = new Dictionary<string, (Marker Marker, MapPin Pin)>();
